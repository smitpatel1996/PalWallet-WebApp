...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    if ($confirm_password == $pwd)
  {
      ...
      if($variable==0)
    {
        ...
        mysqli_select_db($conn,"u629516793_udb");
        $sql = "INSERT INTO usertable VALUES ('{$usrname}','{$pwd}');";
        ...
        echo "<html>
          ...
          <div class=\"w3-center w3-card-12 w3-teal w3-modal-content w3-animate-bottom\">
                                        ...
                                        <div>
          <b class=\"w3-xxlarge\">Sign-Up Successfull</b>
                                        <div class=\"w3-padding-16\">
                                            <img class=\"w3-animate-zoom\" style=\"width:150px;height:150px\" src=\"http://sbt.smartbettracker.com/assets/user_add-ee77f7b2fd74c562d23009a510dd659eaf3ba6396ad6700394c4b40551ba7e8d.png\">
                                        </div>
          <div class=\"w3-padding-bottom w3-padding-top\">
          <a href=\"index.html\"><button class=\"w3-large w3-khaki w3-card-12\"><b>Take me to the Log-In Page.</b></button></a>
          </div>
    ...
    if($variable!=0)
    {
        echo "<html>
          ...
          <div class=\"w3-center w3-card-12 w3-teal w3-modal-content w3-animate-bottom\">
                                        ...
                                        <div>
          <b class=\"w3-xxlarge\">Username Unavailable</b>
                                        <div class=\"w3-padding-16\">
                                            <img class=\"w3-animate-zoom\" src=\"https://projekte.datenpool.at/apps/vtpdelta/vtpdelta.nsf/loginInvalid.png\">
                                        </div>
          <div class=\"w3-padding-bottom w3-padding-top\">
          <a href=\"signup.html\"><button class=\"w3-large w3-khaki w3-card-12\"><b>I have another one for myself.</b></button></a>
          </div>
          <footer class=\"w3-teal w3-container\">
          <br/><br/>
          </footer>
  ...
  else
  {
    echo "<html>
          ...
          <div class=\"w3-center w3-card-12 w3-teal w3-modal-content w3-animate-bottom\">
                                        ...
                                        <div>
          <b class=\"w3-xxlarge\">Passwords do not match.</b>
                                        <div class=\"w3-padding-16\">
                                            <img class=\"w3-animate-zoom\" src=\"https://projekte.datenpool.at/apps/vtpdelta/vtpdelta.nsf/loginInvalid.png\">
                                        </div>
          <div class=\"w3-padding-bottom w3-padding-top\">
          <a href=\"signup.html\"><button class=\"w3-large w3-khaki w3-card-12\"><b>I wanna try again.</b></button></a>
          </div>
          <footer class=\"w3-teal w3-container\">
          <br/><br/>
          </footer>
